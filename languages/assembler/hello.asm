; db (define byte) определяется в секциях .data / .bss можно задать один или несколько байтов,
; которые будут размещены в секции. Это может быть строка, число, символ db 123 / db 'A' / db 0x1 /
; db 'Hello, World!', 0 символ ', 0' это как бы null (конец строки) message db 'Hello', 0
;
